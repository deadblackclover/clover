...
(defvar clover-packages-list '(c-eldoc ag cargo clojure-mode company company-solidity diff-hl
                                     ...
                                     lsp-mode lsp-ui magit mastodon multiple-cursors nasm-mode
                                     nyan-mode package-lint pacmacs paredit php-mode plan9-theme
                                     posframe py-autopep8 python-mode racket-mode rainbow-delimiters
                                     reddigg reverse-im rust-mode sbt-mode scala-mode solidity-mode
                                     treemacs tuareg twtxt wat-mode xah-find xmr-ticker zig-mode))
